...
export const Dashboard: React.FC<DashboardProps> = ({ records }) => {
  ...
  // We'll calculate total duration (start to end) vs total actual work
  // Gap is break time.
  ...
  const breakPercentage = totalTime > 0 ? (totalBreakHours / totalTime) * 100 : 0;
                    ...
                    return (
                        <div key={item.id} className="flex-1 flex flex-col items-center group">
                            <div className="w-full relative flex items-end justify-center h-full">
                                ...
                                >
                                    {/* Tooltip */}
                                    <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10 pointer-events-none">
             ...
             <div className="mt-6 space-y-3">
                 <div className="flex items-center justify-between text-xs">
                     <div className="flex items-center gap-2">
                         ...
                         <span className="font-medium text-slate-600">Jam Kerja</span>
                     </div>
